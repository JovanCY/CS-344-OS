...
int main(int argc, char *argv[])
{
    ...
    while (childCount < 5)
    {
        ...
        case 0:
            ...
            // if accMsg is not enc_client, that means another app connected
            if (strstr(accMsg, "enc_client") == 0)
            {
            ...
            // printf("the message length to be received will be: %d\n", messageLength);
            ...
            // printf("\nSERVER: message loop finished with ack = %d and messageLength = %d\n", strlen(buffer), messageLength);
            // fflush(stdout);
            ...
            // printf("SERVER: the length of the key is %d\n", strlen(key));
            // fflush(stdout);
            // printf("\nSERVER: I received this key from the client: \"%s\"\n", key);
            // fflush(stdout);
